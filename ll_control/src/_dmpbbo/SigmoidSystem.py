...
#
u""" Module for the SigmoidSystem class. """
...
class SigmoidSystem(DynamicalSystem):
    u""" A dynamical system representing a sigmoid system.
    """

    def __init__(self, tau, x_init, max_rate, inflection_ratio):
        u""" Initialize a SigmoidSystem.
        ...
        """
        super(SigmoidSystem, self).__init__(1, tau, x_init)
    ...
    def y_init(self, new_y_init):
        u""" Set the initial state of the dynamical system (y part)
