...
#
u""" Module for the RichardsSystem class. """
...
class RichardsSystem(DynamicalSystem):
    u""" A dynamical system representing a Richard's system (generalized sigmoid system).
    """

    def __init__(self, tau, x_init, x_attr, t_infl_ratio, alpha=1.0, v=1.0):
        super(RichardsSystem, self).__init__(1, tau, x_init)
