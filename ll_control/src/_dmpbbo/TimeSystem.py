...
#
u""" Module for the TimeSystem class. """
...
class TimeSystem(DynamicalSystem):
    u""" A dynamical system with constant velocity, representing the linear passage of time.
    """

    def __init__(self, tau, count_down=False):
        u""" Initialize a TimeSystem
        ...
        super(TimeSystem, self).__init__(1, tau, np.array(x_init))

    @property
    def count_down(self):
        u""" Get whether this TimeSystem counts down or up.
